      ...
      <div className="row">
        <div className="heading text-center">
          ...
          <p>
            ...
            into contact with me, please fill out the form below.
          </p>
        </div>
      </div>
      <div className="row mrgn30">
        <form method="post" action id="contactfrm" role="form">
          ...
          <div className="col-sm-4">
            ...
            <button name="submit" type="submit" className="btn btn-lg btn-primary" id="submit">
              Submit
            </button>
        ...
        <div className="col-sm-4">
          ...
          <h4>Phone:</h4>
          <address>12345-49589-2<br /></address>
        </div>
      </div>
    </div>
    {/*/.container*/}
